...
/**
 * One captured, metadata-only resilience event.
 *
 ...
 * @param policyType neutral policy type, matching {@link ResiliencePolicyDto#type()}
 * @param provider library that emitted the event, matching {@link ResiliencePolicyDto#provider()}
 ...
 */
public record ResilienceEventDto(
        String id,
        long timestamp,
        String policyName,
        String policyType,
