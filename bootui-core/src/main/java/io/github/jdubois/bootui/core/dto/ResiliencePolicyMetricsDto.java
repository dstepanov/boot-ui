...
/**
 * Bounded runtime counters for one resilience policy.
 *
 ...
 */
public record ResiliencePolicyMetricsDto(
    ...
    public static ResiliencePolicyMetricsDto none() {
        return new ResiliencePolicyMetricsDto(null, null, null, null, null, null, null, null);
    }
}
