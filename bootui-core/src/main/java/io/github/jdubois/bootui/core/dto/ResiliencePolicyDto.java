...
/**
 * One configured resilience policy: which protection applies to which operation, how it is configured, and
 ...
 */
public record ResiliencePolicyDto(
        String name,
        String type,
        String provider,
        String source,
        String target,
        String state,
        List<ResiliencePolicySettingDto> settings,
        ResiliencePolicyMetricsDto metrics) {}
