package io.github.jdubois.bootui.webfluxsample.resilience;
...
/**
 * Reactive counterpart of the servlet sample app's {@code SampleResilienceController}: exercises the
 * sample's Resilience4j policies on demand so the BootUI Resilience panel shows real captured events on
...
public class SampleResilienceController {
    ...
    public SampleResilienceController(CircuitBreakerRegistry circuitBreakerRegistry, RetryRegistry retryRegistry) {
        this.circuitBreakerRegistry = circuitBreakerRegistry;
        this.retryRegistry = retryRegistry;
    }

    @GetMapping("/resilience")
    public Mono<Map<String, Object>> exerciseResilience() {
