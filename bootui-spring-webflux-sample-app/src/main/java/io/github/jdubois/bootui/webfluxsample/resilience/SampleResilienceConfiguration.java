...
/**
 * Reactive counterpart of the servlet sample app's {@code SampleResilienceConfiguration}: declares the
 * Resilience4j registries the BootUI Resilience panel reads, so the reactive sample demonstrates the
