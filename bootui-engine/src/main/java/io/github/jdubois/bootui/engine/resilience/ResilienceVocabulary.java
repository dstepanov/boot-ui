...
/**
 * The neutral vocabulary the Resilience contract uses, shared by the engine, every adapter provider and
 * the Live Activity mapping so the three supported libraries render through one stable shape.
 */
public final class ResilienceVocabulary {
     ...
     * user data, identifiers or credentials, and the resilience panel is a metadata-only view.</p>
     */
