 ...
 * {@link MicronautGitHubSettings} config carrier in place of {@code BootUiProperties.GitHub}.</p>
 */
public final class GitHubApiClient implements GitHubClient {
    ...
    private final MicronautGitHubSettings settings;
    ...
    public GitHubApiClient(
            MicronautGitHubSettings settings,
