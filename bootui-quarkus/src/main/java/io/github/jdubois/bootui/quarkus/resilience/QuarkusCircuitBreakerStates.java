 ...
 * {@link QuarkusResiliencePolicyProvider} and {@link QuarkusResilienceCapture} never name a
...
public interface QuarkusCircuitBreakerStates {
    ...
    /**
     * The named breaker's current state as a {@code ResilienceVocabulary} constant, or {@code null} when the
     ...
     * as a {@code ResilienceVocabulary} constant. Unknown names are ignored.
     */
