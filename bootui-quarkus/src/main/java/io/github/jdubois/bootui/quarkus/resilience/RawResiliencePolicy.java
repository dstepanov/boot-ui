 ...
 * runtime via a {@code @Recorder} (see {@link ResiliencePoliciesRecorder}).
 *
 ...
 * {@code <annotation>/<member>}. {@link QuarkusResiliencePolicyProvider} resolves those at request time, so a
 ...
 */
public record RawResiliencePolicy(
        String name,
        String type,
