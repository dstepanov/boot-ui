...
runtimeOnly 'com.julien-dubois.bootui:bootui-spring-boot-starter:1.12.0'
```
...
```groovy
// Groovy DSL (build.gradle)
runtimeOnly 'com.julien-dubois.bootui:bootui-spring-boot-starter-reactive:1.12.0'
```
...
path/method-only explanations are clearly marked as best effort.
...
```groovy
// Groovy DSL (build.gradle)
implementation 'com.julien-dubois.bootui:bootui-quarkus:1.12.0'
```
