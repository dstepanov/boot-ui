...
standalone REST Client panel is not yet ported, and HTTP Sessions is not applicable to a reactive,
...
- On Spring Boot WebFlux: the standalone REST Client panel (see `docs/WEBFLUX-SUPPORT.md`).
...
- Gradle examples.
- Closing the remaining Spring Boot WebFlux gap: the standalone REST Client panel (see `docs/WEBFLUX-SUPPORT.md`).
