...
home: true
heroText: BootUI
tagline: A local-only developer console for Spring Boot 4, Quarkus and Micronaut applications.
actions:
...
features:
  - title: Runtime observability
    details: Inspect health, metrics, memory, threads, heap dumps, startup timing, and JVM sizing from the running Spring Boot, Quarkus or Micronaut app.
...
| Add BootUI to a Spring Boot 4, Quarkus or Micronaut app | [Setup](SETUP.md) |
...
**Quarkus** and **Micronaut**, backed by a shared, framework-neutral engine that serves an identical REST contract on
any of the four.
