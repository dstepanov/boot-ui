  ...
  generatedFiles: [
    {
      ...
      installable: true,
      installPath: 'Dockerfile-crac',
      content: [
        '# Multi-stage Dockerfile for a CRaC (Coordinated Restore at Checkpoint) image of bootui-spring-sample-app.',
        '#',
        '# This scaffold was generated by BootUI for the application the starter is installed in.',
        '# It assumes a single-module Spring Boot application built with the Maven Wrapper.',
        '',
    ...
    },
    {
      ...
      installable: true,
      installPath: 'checkpoint-and-run.sh',
      content: [
        '#!/bin/sh',
        ...
        'fi',
        '',
        'java -XX:CRaCCheckpointTo="$CRAC_CHECKPOINT_DIR" -Dspring.context.checkpoint=onRefresh -jar "$APP_JAR"',
        'exec java -XX:CRaCRestoreFrom="$CRAC_CHECKPOINT_DIR"',
        ''
      ].join('\n')
    }
