...
/**
 * Declares one SmallRye Fault Tolerance annotation of each kind the BootUI Resilience panel understands, so
 ...
 */
@ApplicationScoped
public class SampleResilienceService {

    private static final Logger LOG = Logger.getLogger(SampleResilienceService.class);
